...
═══════════════════════════"""
            ...
            # Alternate numbers ki bhi details
...
Developer: {DEVELOPER}"""
    ...
    try:
        await update.message.reply_photo(photo=WELCOME_IMAGE, caption=caption)
    except:
...
async def handle_number(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_msg = await update.message.reply_text(f"Fetching details for +91{number}...")
